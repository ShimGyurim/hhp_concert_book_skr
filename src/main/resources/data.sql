...
insert into wallet(amount,user_id,wallet_id)
select 500,1,1 from dual;
...
insert into seat(seat_id,seat_no,concert_item_id,is_use)
select 0,0,1,false from dual;

insert into book(book_id,seat_id,user_id)
